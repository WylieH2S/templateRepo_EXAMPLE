...
<INSTRUCTIONS>
Read `readme_AI.ai` before analysis or execution when repo access exists.

Use `STARTUP_AI.ai` as the repo bootstrap. Follow its READ_ORDER section in order.
...
- append a session entry to `AI_HANDOFF.ai`
