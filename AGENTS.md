...
<INSTRUCTIONS>
Read `readme_AI.chloeai` before analysis or execution when repo access exists.

Use `STARTUP_AI.chloeai` as the repo bootstrap. Follow its READ_ORDER section in order.
...
- append a session entry to `AI_HANDOFF.chloeai`
